...
function (_Handler) {
  ...
  function Footnotes(chunker, polisher, caller) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(Footnotes).call(this, chunker, polisher, caller));
    _this.footnotes = {};
    _this.needsLayout = [];
    return _this;
  }
  ...
  (0, _createClass2["default"])(Footnotes, [{
    ...
    value: function createFootnoteCall(node) {
      ...
      try {
        for (var _iterator = node.classList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
