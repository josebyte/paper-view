...
function () {
  ...
  (0, _createClass2["default"])(Chunker, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee5(node, force) {
    ...
    */
    ...
    key: "clonePage",
    value: function () {
      var _clonePage = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee8(originalPage) {
        var lastPage, page, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, className;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 7:
                ...
                for (_iterator = originalPage.element.classList[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
